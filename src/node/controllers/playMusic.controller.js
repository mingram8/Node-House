...
exports.getSong = function(req,res) {
    res.json({play: process.SONG_PLAYING, paused: process.PAUSED, song: process.CURRENT_SONG, on: {coffee: process.COFFEE_ON, bedroom: process.BEDROOM_ON, bedroom2: process.BEDROOM2_ON, brightness:process.BEDROOM2_BRIGHTNESS, christmas: process.CHRISTMAS_ON}});
}
/**
